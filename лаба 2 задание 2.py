...
class Library:
    def __init__(self, books=None):
        # Инициализируем список книг (или пустой, если не передан)
        if books is None:
            books = []
        self.books = books
    ...
    def get_next_book_id(self) -> int:
        ...
        if not self.books:  # Если библиотека пустая
            return 1
        else:  # Если есть книги, находим максимальный id и увеличиваем на 1
